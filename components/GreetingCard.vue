...
.greeting-card__background{inset:3%;width:94%;height:94%;object-position:center 28%;transform:scale(.96);transform-origin:center;transition:transform .3s ease}.is-afternoon .greeting-card__background{object-position:center 22%}.is-evening .greeting-card__background{object-position:center 24%}.greeting-card__veil{opacity:.22}.is-dark .greeting-card__veil{opacity:.16}@media(max-width:760px){.greeting-card__background{inset:2%;width:96%;height:96%;transform:scale(.98)}}
</style>
