...
<template>
  <label class="relative block">
    ...
    <input :value="modelValue" :class="['tf-input pl-10 pr-10', inputClass]" :placeholder="placeholder" type="text" role="searchbox" inputmode="search" @input="emit('update:modelValue', ($event.target as HTMLInputElement).value)" />
