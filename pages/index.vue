        ...
        <section v-else-if="activePage === 'settings'" class="space-y-4">
          ...
          <div class="grid items-stretch gap-4 xl:grid-cols-[1.15fr_.85fr]">
            ...
            <div class="flex h-full flex-col gap-4">
              <div class="tf-panel flex flex-1 flex-col p-5 sm:p-7">
                ...
                <button class="tf-primary mt-auto h-12 w-full rounded-xl text-base" @click="saveSettings('Password')"><svg viewBox="0 0 24 24" class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2"><rect x="5" y="10" width="14" height="11" rx="2" /><path d="M8 10V7a4 4 0 0 1 8 0v3" /></svg>Update Password</button>
              </div>
